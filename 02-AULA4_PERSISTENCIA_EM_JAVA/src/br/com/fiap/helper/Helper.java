...
public class Helper {
	...
	public List<Funcionario> listarFuncionarios() {
		...
		// Alternativa
		// TypedQuery<Funcionario> tQuery = em.createQuery("select f from
		// Funcionario f", Funcionario.class);
	...
	public Funcionario buscarFuncionario(String numMatricula) {
		...
		// TypedQuery<Funcionario> tQuery = em.createQuery("select f from
		// Funcionario f where matricula = :matricula", Funcionario.class);
