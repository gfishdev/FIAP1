...
public class Teste {
	...
	public static void main(String[] args) {
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("AULA4_PERSISTENCIA_EM_JAVA");
		...
		em.close();
		System.out.println("Funcionario " + funcionario.getNome() + " está em Cache? "
				+ cache.contains(Funcionario.class, funcionario.getId()));
